...
window.addEventListener('DOMContentLoaded', function () {
  var modalStateObject = {};
  var deadline = '2022-05-30';
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalStateObject);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalStateObject);
...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (user) {
...
var modals = function modals() {
  function bindelModa(triggerSelector, modalSelector, closeSelector) {
  ...
  bindelModa('.popup_engineer_btn', '.popup_engineer', '.popup_engineer .popup_close');
  bindelModa('.phone_link', '.popup', '.popup .popup_close');
  bindelModa('.popup_calc_btn', '.popup_calc', '.popup_calc_close');
  bindelModa('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false);
  bindelModa('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false);
};
...
var timer = function timer(id, deadline) {
  // Стрелочная техническая функция
